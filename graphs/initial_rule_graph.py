...
builder.add_node("copy_canonical_category", copy_canonical_category_node)
...
builder.add_edge(START, "copy_canonical_category")
builder.add_edge("copy_canonical_category", "persist_rule")
